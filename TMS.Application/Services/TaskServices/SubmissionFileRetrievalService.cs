...
//            }
//            var submission = submissionResult.Data.FirstOrDefault(x => x.Files == request.FileGuidId);
...
//                f => f.FileUniqueIdentifier == request.FileGuidId && f.TaskSubmissionId == submission.Id);
